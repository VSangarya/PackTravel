...
Using continuous integration, automatically running tests whenever changes are made to your source code | 3 | [Build](https://github.com/VSangarya/PackTravel/blob/main/.github/workflows/build.yml) and [Deploy](https://github.com/VSangarya/PackTravel/blob/main/.github/workflows/deploy.yml)| 
